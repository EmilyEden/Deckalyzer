...
EOT1;
	...
	<input type="checkbox" name="forTrade" value="$forTrade">Is this card for trade?<br>
	<input type="text" name="numOwned" pattern="[0-9]" value="$numOwned" maxlength="4" size="8"></p>
...
EOT1;
	...
	<input type="text" name="name" value="$format" placeholder="Format" maxlength="255" size="80"</p>
	<input type ="text" name="name" value="$numWins" pattern = "[0-9]" maxlength="4" size="8"</p>
	<input type="submit" name='submit' value="Submit">
</form>
</body>
</html>
